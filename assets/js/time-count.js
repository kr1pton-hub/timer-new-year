document.addEventListener('DOMContentLoaded', () => {
    ...
    const daysText = document.querySelector('.time-days .time-text');
    const hoursText = document.querySelector('.time-hours .time-text');
    const minutesText = document.querySelector('.time-minutes .time-text');
    const secondsText = document.querySelector('.time-seconds .time-text');
